...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        ...
        f.setForeground(new Color(250, 235, 215));
        f.getContentPane().setForeground(new Color(250, 235, 215));
        f.setSize(900,650);
        f.setLocation(450,150); 
        f.setBackground(new Color(250, 235, 215));
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        b1.setFont(new Font("Sylfaen", Font.BOLD, 15));
