...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,886,700);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(this.getClass().getResource("/b14.jpg"));
        Image i3 = img.getImage().getScaledInstance(2020, 800,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);

        id8 = new JLabel("  New Teacher Details");
        id8.setBounds(320,30,500,50);
        id8.setFont(new Font("Serif", Font.BOLD | Font.ITALIC, 42));
